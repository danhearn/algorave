...
-- OSC FOR TOUCHDESIGNER/PUREDATA

-- let target = Target {oName = "visualiser", oAddress = "127.0.0.1", oPort = 5050, oLatency = 0.2, oSchedule = Live, oWindow = Nothing, oHandshake = False, oBusPort = Nothing }

-- oscplay = OSC "/play" $ ArgList [("s", Nothing), ("vowel", Just $ VS "a"), ("pan", Just $ VF 0.5), ("volume", Just $ VF 1), ("cut", Just $ VI 1), ("intensity", Just $ VI 0) ]
